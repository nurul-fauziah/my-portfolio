        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <motion.div
              ...
              className="absolute -left-24 top-20 h-72 w-72 rounded-full bg-[#81A6C6]/20 blur-3xl"
            />
            <motion.div
              animate={{ x: [0, -20, 25, 0], y: [0, -30, 15, 0] }}
              transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
              className="absolute right-0 top-80 h-80 w-80 rounded-full bg-[#AACDDC]/25 blur-3xl"
            />
          </div>
          ...
          >
            <motion.p
              ...
              className="text-sm uppercase text-[#81A6C6]"
            >
              Welcome
            </motion.p>
